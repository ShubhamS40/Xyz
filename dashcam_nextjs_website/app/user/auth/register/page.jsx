...
export default function UserRegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validation
    if (!formData.email || !formData.password || !formData.companyType) {
      setError('Email, password, and company type are required');
      return;
    }
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full pl-10 pr-10 py-2 rounded-lg border border-gray-300 text-sm text-gray-900 bg-white focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900 appearance-none"
                  required
                  disabled={loading}
                >
